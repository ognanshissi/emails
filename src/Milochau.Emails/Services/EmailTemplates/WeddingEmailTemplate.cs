...
{
    public class WeddingEmailTemplate : IEmailTemplate
    {
        private readonly ITranslationService translationService;
        protected readonly HtmlEncoder htmlEncoder;

        public WeddingEmailTemplate(ITranslationService translationService,
...
@"</div>";
        ...
        private string GetBodyHeader(Email email)
        {
            ...
            if (!string.IsNullOrEmpty(header))
            {
                var result = @"
<tr>
    <td align=""center"" valign=""top"" style=""font-size:0; padding: 35px;"" bgcolor=""#F6F8EF"">
        <div style=""display:inline-block; vertical-align:top; width:100%;"">
            <table align=""center"" border=""0"" cellpadding=""0"" cellspacing=""0"" width=""100%"">
                <tr>
                    <td align=""center"" valign=""top"" style=""font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 28px; font-weight: 600; line-height: 48px;"" class=""mobile-center"">";
                if (!string.IsNullOrEmpty(email.Context.HomeUrl))
                {
                    result += @"<a href=""" + email.Context.HomeUrl + @""" target=""_blank"" rel=""noopener"" style=""color: #333333; text-decoration: none;"">
                        <h1 style=""font-size: 28px; font-weight: 600; margin: 0; color: #333333;"">" + htmlEncoder.Encode(header) + @"</h1>
                    </a>";
                }
                else
                {
                    result += @"<h1 style=""font-size: 28px; font-weight: 800; margin: 0; color: #333333;"">" + htmlEncoder.Encode(header) + @"</h1>";
                }
                result += @"
                    </td>
                </tr>
    ...
    <td align=""center"" style=""padding: 15px 35px 20px 35px; background-color: #ffffff;"" bgcolor=""#ffffff"">
        ...
        private string GetBodyCallToAction(Email email)
        {
            if (!string.IsNullOrEmpty(email.CallToAction.Url))
            {
                return @"
<tr>
    <td align=""center"" style="" padding: 25px; background-color: #F6F8EF;"" bgcolor=""#F6F8EF"">
        <!--[if (gte mso 9)|(IE)]>
        <table align=""center"" border=""0"" cellspacing=""0"" cellpadding=""0"" width=""600"">
        <tr>
        <td align=""center"" valign=""top"" width=""600"">
           ...
           /* Call to action description
               <tr>
                   <td align=""center"" style=""font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px; padding-top: 25px;"">
                       <h2 style=""font-size: 24px; font-weight: 800; line-height: 30px; color: #333333; margin: 0;"">
           ...
           @"<tr>
                <td align=""center"" style=""padding: 5px 0 5px 0;"">
                    <table border=""0"" cellspacing=""0"" cellpadding=""0"">
                        <tr>
                            <td align=""center"" style=""border-radius: 5px;"" bgcolor=""#edf0e1"">
                                <a href=""" + email.CallToAction.Url + @""" target=""_blank"" rel=""noopener"" style=""font-size: 18px; font-family: Open Sans, Helvetica, Arial, sans-serif; color: #333333; text-decoration: none; border-radius: 5px; background-color: #edf0e1; padding: 15px 30px; border: 1px solid #edf0e1; display: block;"">" + htmlEncoder.Encode(email.CallToAction.Title) + @"</a>
                            </td>
                        </tr>
                    </table>
                </td>
...
<tr>
    <td align=""center"" style=""font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 400; line-height: 24px;"">
        ...
        private string GetBodyFooterImage(Email email)
        {
            if (!string.IsNullOrEmpty(email.Context.Signature.ImageUrl))
            {
                return @"
<tr>
    <td align=""center"" style=""font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 400; line-height: 24px; padding: 5px 0 10px 0;"">
        <img src=""" + email.Context.Signature.ImageUrl + @""" alt=""footer"" style=""max-height: 160px;""/>
    </td>
</tr>";
            }
            else
...
<tr>
    <td align=""center"" style=""font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 400; line-height: 24px; padding: 5px 0 10px 0;"">
        <p style=""font-size: 14px; font-weight: 600; line-height: 18px; color: #333333;"">" +
            signatureName +
        @"</p>
    </td>
</tr>";
...
<tr>
    <td align=""center"" style=""font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px;"">
        <img src=""https://assets.antoine-et-raphael.com/images/emails/header-2.png"" alt=""header"" style=""max-height: 100px;""/>
    </td>
</tr>";
        }
...
<tr>
    <td align=""center"" style=""font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px;"">
        <p style=""font-size: 16px; font-weight: 400; line-height: 24px; color: #444444;"">" +
